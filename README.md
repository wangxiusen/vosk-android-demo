...
- 任意文字口播页使用 sherpa-onnx 和分语言 VITS 模型：中文 AISHELL3 提供 10 种已核对并完成真机合成的女声（北方、南方各 5 种），英文使用 Piper LJSpeech 女声；可切换 0.8/1.0/1.2 三档语速和 0.5×/1.0×/1.5× 三档标点停顿，并按 PCM 能量实时驱动四个嘴型。
